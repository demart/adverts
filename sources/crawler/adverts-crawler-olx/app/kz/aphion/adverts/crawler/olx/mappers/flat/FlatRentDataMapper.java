			...
			switch (entry.getKey()) {
				...
				case "has_phone":
					...
					if ("1".equals(entry.getValue())) {
						...
						Logger.warn("Olx Advert has_phone field [%s] not equals 1, maybe there is no any phones",  entry.getValue());
					}
					break;
				case "has_email":
					// "has_email": 1,
				...
				case "Объявление от":
					...
					switch (value) {
						...
						case "Агентства":
							...
							break;
						default:
							Logger.warn("Found new key in advert parameter [%s] with value [%s]", name, value);
							break;
					}
