...
public class IrrCrawlerJob extends CrawlerProcessJob {
	...
	private void startCrawle() throws CrawlerException, IOException, Exception {
		...
		// Статистика
		Logger.info("{\"new\":%d, \"existing\":%d, \"up-to-date\":%d, \"updated\":%d,  \"total\":%d}", foundNewAdvertsCount, foundExistingAdvertsCount, foundExistingUpToDateAdvertsCount, foundExistingUpdateAdvertsCount, totalCount);
	 ...
	 * @throws IOException
	 */
	public static String callServerAndGetJsonData(String targetUrl, CrawlerModel crawlerModel) throws CrawlerException, IOException {
