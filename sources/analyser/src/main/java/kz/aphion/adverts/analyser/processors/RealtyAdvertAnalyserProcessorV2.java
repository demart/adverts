...
public class RealtyAdvertAnalyserProcessorV2 implements AdvertAnalyserProcessor  {
	
	private static Logger logger = LoggerFactory.getLogger(RealtyAdvertAnalyserProcessorV2.class);
	...
	private void processNewAdvert(ProcessRealtyModel model) throws JMSException, Exception {
		...
		logger.info("Realty model with id: "+ model.advertId + " is NEW and will be send to subscription module.");
		...
		logger.info("Realty model with id: "+ model.advertId + " was sent to subscription module.");
	}
	...
	private void processExistingAdvert(ProcessRealtyModel model) {
		logger.info("Realty model with id: "+ model.advertId + " is UPDATED, for now skipped");
