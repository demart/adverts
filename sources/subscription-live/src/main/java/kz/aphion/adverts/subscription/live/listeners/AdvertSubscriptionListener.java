...
import kz.aphion.adverts.subscription.live.processors.AdvertSubscriptionProcessorImpl;
...
public class AdvertSubscriptionListener implements MessageListener  {
	...
	private static Logger logger = LoggerFactory.getLogger(AdvertSubscriptionListener.class);

	@Override
	public void onMessage(Message message) {
		try {
			Thread.currentThread().setName("LiveAdvertListener");
